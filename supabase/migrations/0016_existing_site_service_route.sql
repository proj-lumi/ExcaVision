-- Repair and more-coverage requests may add a monitoring unit at an existing site.
-- This route never creates a new site.
...
begin
  ...
  if destination_site_id is null then raise exception 'select an existing site first'; end if;
