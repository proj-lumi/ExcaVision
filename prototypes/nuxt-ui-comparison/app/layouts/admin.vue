...
const navigation = [[
  ...
  { label: 'Requests', icon: 'i-lucide-inbox', to: '/admin/requests' },
  { label: 'Installations', icon: 'i-lucide-hard-hat', to: '/admin/installations' },
  { label: 'Inventory', icon: 'i-lucide-cpu', to: '/admin/inventory' },
  { label: 'Sites', icon: 'i-lucide-map-pin', to: '/admin/sites' }
]]
</script>
