...
<template>
  <div class="grid gap-4">
    ...
    <UAlert v-if="latestAdvisory" color="warning" variant="subtle" icon="i-lucide-triangle-alert" :title="latestAdvisory.detail" :description="`${latestAdvisory.unit} · ${latestAdvisory.time}`" :actions="[{ label: 'View alerts', to: '/app/alerts', color: 'warning', variant: 'outline' }]" />
